...
namespace MonitoringSite.Extensions
{
    public static class DependencyExtensions
    {
        public static IHealthChecksBuilder AddDependencies( this IHealthChecksBuilder builder, List<MonitoringDependency> dependencies)
        {
